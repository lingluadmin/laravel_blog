...
CREATE TABLE `blog_blogs` (
  ...
  `intro` 	text 		    COLLATE utf8_unicode_ci   DEFAULT '' 	  COMMENT '介绍',
  ...
  `content` 	text 		  COLLATE utf8_unicode_ci   DEFAULT ''	  COMMENT '文章内容',
...
CREATE TABLE `blog_user` (
  ...
  `intro`     text      COLLATE utf8_unicode_ci DEFAULT ''  COMMENT '简介',
